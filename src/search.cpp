...
int correction_value(const Worker& w, const Position& pos, const Stack* const ss) {
    ...
    const auto  pcv   = w.pawnKingCorrectionHistory[pawn_king_index<Correction>(pos)][us];
...
void update_correction_history(const Position& pos,
    ...
    workerThread.pawnKingCorrectionHistory[pawn_king_index<Correction>(pos)][us]
      << bonus * 111 / 128;
...
void Search::Worker::clear() {
    ...
    pawnKingCorrectionHistory.fill(5);
