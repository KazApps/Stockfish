...
Value Search::Worker::search(
  NodeType nodeType, Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {

    const bool PvNode   = nodeType != NonPV;
    const bool rootNode = nodeType == Root;
...
Value Search::Worker::qsearch(NodeType nodeType, Position& pos, Stack* ss, Value alpha, Value beta) {
