...
constexpr int PAWN_KING_HISTORY_SIZE   = 2048;   // has to be a power of 2
...
inline int pawn_king_index(const Position& pos) {
    ...
    return (pos.pawn_key() ^ ksqKeys[kingZone])
...
// PawnKingHistory is addressed by the pawn structure, king position, and a move's [piece][to]
...
enum CorrHistType {
    PawnKing,      // By color pawn structure, and king position
